...
##Goal
Learn how to manipulate data in the *tidyverse*, keep data organized and [pretty](https://en.wikipedia.org/wiki/Pretty_Things), and __reproducible__. I also want to learn how to make awesome graphs and maps from the data I have tidied in **R**.
